...
class Handlers
{
    ...
    */
    ...
    // Constants, add by ZJ, at 20170531
    // https://msdn.microsoft.com/en-us/library/z9ty6h50(VS.85).aspx
    public static var ForReading = 1;
    public static var ForWriting = 2;
    public static var ForAppending = 8;

    public static var TristateUseDefault = -2;  // Opens the file using the system default
    public static var TristateTrue = -1;  // Opens the file as Unicode
    ...
    function DoSaveSession(oSessions: Session[]) {
        ...
        var file;
        if (fso.FileExists(absFilePathSessionsData)) {
            // object.OpenTextFile(filename, iomode, create, format)
            file = fso.OpenTextFile(absFilePathSessionsData, ForWriting, false, TristateFalse);
        } else {
            // object.CreateTextFile(filename, overwrite, unicode)
            // unicode = false if it's created as an ASCII file
        ...
        shellRunTime.Run("Python " + absFilePathPyScript + " -d " + absFilePathSessionsData);
    }
    ...
    static function OnBeforeRequest(oSession: Session) {
        ...
        // Customize rules for ad logs
        if (oSession.fullUrl.Contains(urlKeyword)) {
            var fso = new ActiveXObject("Scripting.FileSystemObject");
...
*/
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        // Customize rules for ad logs, add by ZJ, at 20170525
        if (oSession.fullUrl.Contains(urlKeyword)) {
            var fso = new ActiveXObject("Scripting.FileSystemObject");
